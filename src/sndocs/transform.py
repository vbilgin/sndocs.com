...
def _parse_frontmatter_fallback(frontmatter: str) -> dict:
    ...
    ServiceNowDocs occasionally emits unquoted ``: `` sequences in scalar
    titles or descriptions. Parsing each known field independently keeps that
    text intact while still decoding valid lists, dates, and numbers.
    """
    metadata: dict = {}
